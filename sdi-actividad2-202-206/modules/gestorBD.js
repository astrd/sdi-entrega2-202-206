module.exports = {
    ...
    resetDB:function (  funcionCallback) {
        this.mongo.MongoClient.connect(this.app.get('db'), function (err, db) {
            if (err) {
                ...
                var ofertas=db.collection('ofertas');
                ofertas.remove();
    ...
    //inserta una oferta en la tabla ofertas
    ...
    //obtener mensajes de acuerdo a un criterio
    ...
    //obtener ofertas de acuerdo a un criterio
...
//marcar mensaje como leido
    ...
    //eliminar mensajes de una conver de acuerdo a un criterio
